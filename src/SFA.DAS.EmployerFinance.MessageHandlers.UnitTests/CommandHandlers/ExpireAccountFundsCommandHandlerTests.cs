...
using SFA.DAS.EmployerFinance.MessageHandlers.CommandHandlers.Levy;
...
public class ExpireAccountFundsCommandHandlerTestsFixture
{
    ...
    private static bool AreFundsInEqual(IEnumerable<LevyFundsIn> fundsInList, IDictionary<CalendarPeriod, decimal> expiredFundsDictionary)
    {
    ...
    private static bool AreFundsOutEqual(IEnumerable<PaymentFundsOut> fundsOutList, IDictionary<CalendarPeriod, decimal> expiredFundsDictionary)
    {
