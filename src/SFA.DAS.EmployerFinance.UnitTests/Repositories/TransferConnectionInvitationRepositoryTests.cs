...
public class TransferConnectionInvitationRepositoryTests : FluentTest<TransferConnectionInvitationRepositoryTestFixture>
{
    ...
    {
        TestAsync(f => f.GetLatestPendingByReceiver(), f => f.TransferConnectionInvitation.Should().NotBeNull()
    ...
    {
        TestAsync(f => f.GetByReceiver(1, f.ReceiverAccount2.Id, TransferConnectionInvitationStatus.Pending), f => f.TransferConnectionInvitation.Should().NotBeNull()
            .And.Match<TransferConnectionInvitation>(r =>
                r != null &&
    ...
    {
        TestAsync(f => f.GetByReceiver(3, f.SenderAccount1.Id, TransferConnectionInvitationStatus.Pending), f => f.TransferConnectionInvitation.Should().NotBeNull()
            .And.Match<TransferConnectionInvitation>(r =>
                r != null &&
    ...
    {
        TestAsync(f => f.GetBySenderOrReceiver(4, f.SenderAccount3.Id), f => f.TransferConnectionInvitation.Should().NotBeNull()
            .And.Match<TransferConnectionInvitation>(r =>
                r != null &&
        ...
        TestAsync(f => f.GetBySenderOrReceiver(4, f.ReceiverAccount4.Id), f => f.TransferConnectionInvitation.Should().NotBeNull()
            .And.Match<TransferConnectionInvitation>(r =>
                r != null &&
                r.Id == f.PendingReceivedTransferConnectionInvitation4.Id &&
                r.SenderAccount.Id == f.SenderAccount3.Id &&
    ...
    {
        TestAsync(f => f.GetBySenderOrReceiver(f.SenderAccount1.Id), f => f.TransferConnectionInvitations.Should().NotBeNull()
            .And.Match<List<TransferConnectionInvitation>>(r =>
                r != null &&
                r.Count == 4));

        TestAsync(f => f.GetBySenderOrReceiver(f.ReceiverAccount2.Id), f => f.TransferConnectionInvitations.Should().NotBeNull()
            .And.Match<List<TransferConnectionInvitation>>(r =>
                r != null &&
                r.Count == 4));
    }
...
public class TransferConnectionInvitationRepositoryTestFixture 
{
