...
namespace SFA.DAS.EmployerFinance.Api.Filters;
...
public class StopwatchFilterAttribute : ActionFilterAttribute
{
    ...
    public override void OnActionExecuted(ActionExecutedContext context)
    {
        ...
        _logger.LogInformation("Controller action took {ElapsedMilliseconds} to complete: {ControllerName}.{ActionName}", _stopWatch.ElapsedMilliseconds, controllerName, actionName);
    }
}