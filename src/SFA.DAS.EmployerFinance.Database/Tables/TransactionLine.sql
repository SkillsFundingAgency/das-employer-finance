...
CREATE UNIQUE NONCLUSTERED INDEX [UK_TransactionLine_AccountId_TransactionType_Ukprn_PeriodEnd] ON [employer_financial].[TransactionLine] ([AccountId] ASC, [Ukprn] ASC, [PeriodEnd] ASC) WHERE [TransactionType] = /* Payment */ 3
GO
