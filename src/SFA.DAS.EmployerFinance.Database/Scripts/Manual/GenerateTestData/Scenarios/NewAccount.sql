...
--
-- A recently onboarded employer account with only 3 months of levy and
-- payment history. Useful for testing UI states where history is short.
--
-- Requires SQLCMD mode: Query > SQLCMD Mode in SSMS, or natively in Azure Data Studio
-- =============================================================================

-- ===================== CONFIGURATION - CHANGE THESE ========================
:setvar AccountId         101
:setvar PayeScheme        "101/NA00001"
:setvar AccountName       "New Account Ltd"
:setvar MonthlyLevy       2000
:setvar LevyAllowance     3000
:setvar NumberOfMonths    3
:setvar MonthlyPayments   1000
...
BEGIN TRANSACTION ScenarioNewAccountLevies
GO
...
COMMIT TRANSACTION ScenarioNewAccountLevies
